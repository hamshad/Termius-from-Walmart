...
- [x] **CONN-06**: Confirmation dialog before destructive actions (delete)
...
- [x] **ARCH-01**: Modular codebase — separate packages for UI, SSH, storage, models
- [x] **ARCH-02**: No deprecated standard library APIs (ioutil removed)
- [x] **ARCH-03**: No debug logging in production code
- [x] **TEST-01**: Unit tests for storage (load, save, config integrity)
...
| ARCH-01 | Phase 01 | Done |
| ARCH-02 | Phase 01 | Done |
| ARCH-03 | Phase 01 | Done |
| TEST-01 | Phase 01 | Done |
